...
Os protótipos e telas desenvolvidos serão produzidos utilizando as etapas do Atomic Design. Ou seja: de maneira modular, os componentes de uma página serão pensados e unidos, seguindo os conceitos de átomo, molécula, organismo, template e página. A figura 5 mostra a aplicação da metodologia.

<div align="center">
    <font size="3">
        <p style="text-align: center"><b>Figura 5:</b> BPMN do Atomic Design</p>
    </font>
