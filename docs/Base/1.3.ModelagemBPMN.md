...
|:------:| ---------- | ------------------------ |:--------------------------------------------------:|:--------------------------------------------------:|
| `1.0`  | 01/11/2024 | Adição do BPMN de Registro e autenticação | [Izabella Alves](https://github.com/izabellaalves) | [Zenilda Vieira](https://github.com/ZenildaVieira) |
| `1.1`  | 01/11/2024 | Adição do BPMN de Fórum e Autenticação | [Lucas Victor Ferreira](https://github.com/Lucas13032003) | [Mateus Fidelis](https://github.com/MatsFidelis)   |
